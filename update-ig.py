...
def uazku():
    rr = random.randint
    rc = random.choice
    uazku1 = f"Mozilla/5.0 (iPhone; CPU iPhone OS {str(rr(1,12))}_{str(rr(1,15))} like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/{str(rr(40,299))}.0.{str(rr(2800,7999))}.{str(rr(40,399))} Mobile/15E148 Safari/604.1"
    uazku2 = f"Mozilla/5.0 (Linux; Android {VA}; {poco} Build/{VB}.{VB2}.{VB1}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{VC} Mobile Safari/537.36"
    uazku3 = f"Mozilla/5.0 (Linux; Android {VA}; {poco}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{VC} Mobile Safari/537.36"
    uazku4 = f"Mozilla/5.0 (Linux; Android {VA}; {samsung} Build/{VB}.{VB2}.{VB1}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{VC} Mobile Safari/537.36"
    uazku5 = f"Mozilla/5.0 (Linux; Android {VA}; {samsung}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{VC} Mobile Safari/537.36"
    uazku6 = f"Mozilla/5.0 (Linux; Android {VA}; {oppo} Build/{VB}.{VB2}.{VB1}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{VC} Mobile Safari/537.36"
    uazku7 = f"Mozilla/5.0 (Linux; Android {VA}; {oppo}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{VC} Mobile Safari/537.36"
    uazku8 = f"Mozilla/5.0 (Linux; Android {VA}; {vivo}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{VC} Mobile Safari/537.36"
    uazku8 = str(rc([uazku1, uazku2, uazku3, uazku4, uazku5, uazku6, uazku7, uazku8]))
    return uazku8ghhhj

for xc in range(1000):
    rr = random.randint
    rc = random.choice
    uaz1 = f"Mozilla/5.0 (Linux; U; Linux i581 x86_64; en-US) Gecko/20100101 Firefox/47.2"
    uaz2 = f"Mozilla/5.0 (iPad; CPU iPad OS 8_9_3 like Mac OS X) AppleWebKit/534.48 (KHTML, like Gecko) Chrome/53.0.2030.268 Mobile Safari/603.3"
    uaz3 = f"Mozilla/5.0 (iPod; CPU iPod OS 11_0_8; like Mac OS X) AppleWebKit/603.37 (KHTML, like Gecko) Chrome/49.0.2812.305 Mobile Safari/600.2"
...
for typo in range(10000):
    rr = random.randint
    rc = random.choice
    uazku1 = f"Mozilla/5.0 (Macintosh; Intel Mac OS X {os_versi} AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{chrome} Safari/537.36"
    uazku2 = f"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{chrome} Safari/537.36"
    uazku3 = f"Mozilla/5.0 (iPhone; CPU iPhone OS {versi_os} like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.3.1 Mobile/15E148 Safari/604.1"
    uazku4 = f"Mozilla/5.0 (Linux; Android {versi_android}; SM-G610F Build/NRD90M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{chrome} Mobile Safari/537.36"
    uazku5 = f"Mozilla/5.0 (Linux; Android {versi_android}; SM-G532G Build/MMB29T) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{chrome} Mobile Safari/537.36"
    uazku6 = f"Mozilla/5.0 (Linux; Android {str(rr(7,12))}; Redmi {str(rr(7,12))}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/ {str(rr(75,150))}.0.{str(rr(5111,5999))}.{str(rr(73,99))} Mobile Safari/537.36"
    uazku7 = f"Mozilla/5.0 (Linux; Android {str(rr(7,12))}; SM-{a}{b}{c}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/ {str(rr(75,150))}.0.{str(rr(5111,5999))}.{str(rr(73,99))} Mobile Safari/537.36"
    uazku8 = f"Mozilla/5.0 (Linux; Android {str(rr(7,12))}; Infinix X671) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/ {str(rr(75,150))}.0.{str(rr(5111,5999))}.{str(rr(73,99))} Mobile Safari/537.36"
    uazku9 = f"Mozilla/5.0 (Linux; Android  {str(rr(1,20))}; android){str(rc(gt))})Applewebkit/537.36 (KHTML, like Gecko) Chrome/{str(rr(50,140))}.0.{str(rr(3990,5001))}.{str(rr(20,170))} Safari/537.36 OPR/11.5.2685.29640"
...
for NazriXDGantengNgab in range(1000):
   ...
   deviceku = rc([
                  ...
                  "B3-A20",
                  "XT720"])
   ugent1 = f"Mozilla/5.0 (Linux; Linux i661 ; en-US) Gecko/20100101 Firefox/47.6"
   ugent2 = f"Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_11_3; en-US) AppleWebKit/601.15 (KHTML, like Gecko) Chrome/51.0.1974.195 Safari/534"
   ugent3 = f"Mozilla/5.0 (Android; Android 5.0; SM-G480 Build/LRX22C) AppleWebKit/603.40 (KHTML, like Gecko) Chrome/51.0.1652.377 Mobile Safari/602.9"
...
def waktu():
	now = datetime.now()
	hours = now.hour
	if 4 <= hours < 12:timenow = "ROBET"
	elif 12 <= hours < 15:timenow = "ROBET"
	elif 15 <= hours < 18:timenow = "ROBET"
	else:timenow = "ROBET"
	return timenow
def jalan(keliling):
	for mau in keliling + '\n':
...
| $$\  $ | $$| $$  | $$| $$      | $$  | $$| $$\  $$$| $$  \ $$
| $$ \/  | $$| $$  | $$| $$$$$$$$| $$  | $$| $$ \  $$|  $$$$$$/
{K2}|__/     |__/|__/  |__/|________/|__/  |__/|__/  \__/ \______/ 
"""
...
class instagram:
	...
	def logo(self):
		...
		#	urut.append(Panel(f"{P2}Nama      : {H2}{nama}\n{P2}Username  : {H2}{self.username}\n",title=f"{M2}• {K2}• {H2}•{P2} {P2}Data {H2}• {K2}• {M2}•",width=80,padding=(0,3),style=f"{color_table}"))
			prints(Panel(f"{P2}\t      {H2}{nama}{P2} si raja coli",width=80,style=f"{color_table}"))
			prints(Panel(f"""[white][[blue]01[white]]. Crack Dari Pencari Nama        [white][[blue]04[white]]. Crack Hasil [white]CP
...
[white][[blue]03[white]]. Crack Dari Mengikuti           [white][[red]E[white]]. [red]LogOut """,title=f"[{P2} Pilihan Menu {hapus}]",width=80,padding=(0,4),style=f"{color_table}"))
	...
	def ua_sam(self):
		rr=random.randint
		rc=random.choice
		oppo = ['CPH1911|NRD90M', 'CPH1717|LRX22G', 'CPH1909|KOT49H', 'CPH1727|LMY47V', 'CPH1859|KOT49H', 'CPH1879|KOT49H', 'CPH1937|KTU84P', 'CPH1941|KOT49H', 'CPH1851|LRX22C', 'CPH1909|LMY47V', 'CPH1939|NRD90M', 'CPH1909|LMY47V', 'CPH1969|NMF26X', 'CPH1893|IML74K', 'CPH1909|LMY47V', 'CPH1971|JZO54K', 'CPH1967|LRX22G', 'CPH1935|KOT49H', 'CPH1851|JDQ39', 'CPH1959|NRD90M', 'CPH1937|KTU84P', 'CPH1967|KOT49H', 'CPH1911|LMY47V', 'CPH1919|MMB29M', 'CPH1921|MMB29M', 'CPH1919|MMB29M', 'CPH1933|KOT49H', 'CPH1967|LRX22G', 'CPH1909|LMY47V', 'CPH1911|LMY47V', 'CPH1909|LMY47V', 'CPH1963|KOT49H', 'CPH1931|KOT49H', 'CPH1849|KOT49H', 'CPH1913|KOT4', 'CPH1941|KOT49H', 'CPH1923|LRX22G', 'CPH1919|MMB29M', 'CPH1941|KOT49H', 'CPH1935|MMB29K', 'CPH1969|NMF26X', 'CPH1971|JZO54K', 'CPH1911|LMY47V', 'CPH1911|LMY47V', 'CPH1923|MMB29M', 'CPH1839|JSS15J', 'CPH1851|LRX22C', 'CPH1909|LMY4', 'CPH1969|NMF26X', 'CPH1923|MMB29M', 'CPH1971|KOT49H', 'CPH1937|KTU84P', 'CPH1955|KOT49H', 'CPH1849|JZO54K', 'CPH1909|LMY47V', 'CPH1893|JZO54K', 'CPH1921|MMB29M', 'CPH1939|NRD90M', 'CPH1969|NMF26X', 'CPH1937|KTU84P', 'CPH1971|KOT49H', 'CPH1967|LRX22G', 'CPH1969|MMB29M', 'CPH1969|NMF26X', 'CPH1909|LMY47V', 'CPH1911|LMY47V', 'CPH1911|LMY47V', 'CPH1935|JDQ39', 'CPH1849|KOT49H', 'CPH1923|LRX22G', 'CPH1939|NRD90M', 'CPH1971|KOT4', 'CPH1963|KOT49H', 'CPH1849|KOT49H', 'CPH1919|LMY47V', 'CPH1973|NRD90M', 'CPH1831|KTU84P', 'CPH1831|KTU84P', 'CPH1971|KOT49H', 'CPH1971|KOT49H', 'CPH1923|MMB29M', 'CPH1859|KOT49H', 'CPH1969|NMF26X', 'CPH1909|LMY47V', 'CPH1933|JDQ39', 'CPH1831|KTU84P', 'CPH1933|JZO54K', 'CPH1971|KOT49H', 'CPH1965|LRX22G', 'CPH1909|LMY47V', 'CPH1935|KOT49H', 'CPH1911|LMY47V', 'CPH1969|NMF26X', 'CPH1973|NRD90M', 'CPH1913|KOT49H', 'CPH1891|KOT49H', 'CPH1909|LMY47V', 'CPH1959|NRD90M', 'CPH1939|NRD90M', 'CPH1937|KOT49H', 'CPH1971|KOT49H', 'CPH1831|KTU84P', 'CPH1935|NRD90M', 'CPH1969|NMF26X', 'CPH1965|LRX22G', 'CPH1849|KOT49H', 'CPH1913|JZO54K', 'CPH1839|JSS15J', 'CPH1849|KOT49H', 'CPH1967|LRX22G', 'CPH1973|NRD90M', 'CPH1963|JDQ39', 'CPH1909|LMY47V', 'CPH1859|KOT49H', 'CPH1957|JDQ39', 'CPH1935|KOT49H', 'CPH1969|NMF26X', 'CPH1923|MMB29M', 'CPH1849|KOT49H', 'CPH1933|JDQ']
	...
	def ua_v2(self):
	    ...
	    f'Instagram {random.randrange(37,41)}.0.0.{random.randrange(10,99)}.{random.randrange(10,99)} Android (21/{random.randrange(5,12)}.0.1; {dpi}dpi; 1080x2201; oppo; oppo 1851; 1851; qcom; en_US; 382290498)',
	    f'Instagram {random.randrange(37,41)}.0.0.{random.randrange(10,99)}.{random.randrange(10,99)} Android (24/{random.randrange(5,12)}.0; {dpi}dpi; 1080x2278; oppo; oppo 1939; 2004; qcom; en_US; 383877305)',
 ...
 {SE}╰─────────────────────────────────╯{SE} ╰───────────────────────────────────╯''',title=f"[[white] Cek Hasil [/]]",width=80,style=f"{color_table}"))
	...
	def ua_ig(self):
		rr=random.randint
		rc=random.choice
		return (f"Mozilla/5.0 (Linux; Android 9; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/117.0.0.0 Mobile Safari/537.36")
		return (f"Mozilla/5.0 (Linux; Android 9; M2006C3LG) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.101 Mobile Safari/537.36")
		return (f"Mozilla/5.0 (Linux; Android 9; M2006C3LG Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/109.0.5414.117 Mobile Safari/537.36 GoogleApp/14.25.13.28.arm")
		return (f"Mozilla/5.0 (Linux; Android 9; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Mobile Safari/537.36")
		return (f"Mozilla/5.0 (Linux; Android 10; V2111) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.114 Mobile Safari/537.36")
...
if __name__=='__main__':
	...
	try:
		with requests.Session() as ses:
	         ko = ses.get('https://pastebin.com/raw/64DqAAcv').json()
	         HARIS.update(ko)
	         ki = ses.get('https://pastebin.com/raw/eFUmdtSM').json()
	         HARIS1.update(ki)
	         os.system("git pull")
	         login_kamu()
	except Exception as e:
